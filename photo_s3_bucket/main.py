...
from photo_s3_bucket.pages.rate import get_rating, update_rating
...
if __name__ == "__main__":
    ...
    app.add_url_rule("/vote", "get_vote", get_rating)
    app.add_url_rule("/vote", "update_vote", update_rating, methods=["PUT"])
