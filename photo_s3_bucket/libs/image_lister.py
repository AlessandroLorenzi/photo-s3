...
class ImageLister:
    ...
    def list_subdirs(self, folder: str):
        subdirs =  self.s3_client.list_objects_v2(Bucket=self.bucket_name, Prefix=folder, Delimiter='/')
    ...
    def list_objects(self, folder: str):
        return self.s3_client.list_objects_v2(Bucket=self.bucket_name, Prefix=folder, Delimiter='/')
